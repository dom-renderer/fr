...
@section('content')
    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            {{ $page_description }}
            @if(auth()->user()->can('packaging-materials.create'))
                <a href="{{ route('packaging-materials.create') }}" class="btn btn-primary btn-sm float-end">Add Packaging Material</a>
            @endif
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped w-100" id="packaging-materials-table">
                <thead>
                <tr>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('#packaging-materials-table').DataTable({
        processing: false,
        ordering: false,
        serverSide: true,
        ajax: "{{ route('packaging-materials.index') }}",
        columns: [
