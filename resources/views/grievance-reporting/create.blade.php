...
<div class="container-fluid py-4">
    ...
    <form id="grievanceForm" method="POST" action="{{ route('grievance-reporting.store') }}">
        @csrf
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control select2" name="order_id" id="order_id" required>
                                    ...
                                    @foreach($orders as $order)
                                        <option value="{{ $order->id }}">{{ $order->order_number }} ({{ date('d-m-Y', strtotime($order->created_at)) }})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label">Remarks</label>
                                <textarea class="form-control" name="remarks" rows="2" placeholder="Overall notes..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
